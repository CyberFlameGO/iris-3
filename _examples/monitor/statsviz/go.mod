module github.com/kataras/iris/v12/_examples/statsviz

go 1.17

require (
	github.com/arl/statsviz v0.4.2-0.20220222093618-583356d48628
	github.com/kataras/iris/v12 v12.2.0-alpha9.0.20220302032625-c7f90f7e6514
)
